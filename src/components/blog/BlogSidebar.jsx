...
import { buttonHover, buttonTap, cardHover } from "../../utils/motionVariants";
...
function BlogSidebar({
  ...
  return (
    <aside className="space-y-6">
      {/* Categories */}
      <FadeIn className="rounded-2xl border border-slate-200 bg-white p-6 shadow-[0_10px_30px_rgba(15,23,42,0.05)]">
